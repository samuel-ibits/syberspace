    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:0 auto;background:#0a0f1e;color:#e2e8f0;padding:32px;border-radius:16px">
          ...
          <a href="https://syberspacesolutions.live" style="display:inline-block;margin-top:20px;padding:12px 24px;background:#06b6d4;color:#0a0f1e;border-radius:8px;text-decoration:none;font-weight:600">Visit Syberspace →</a>
