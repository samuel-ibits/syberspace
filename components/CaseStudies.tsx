...
const cases = [
  {
    ...
    industry: "Healthcare",
    challenge: "Their support team was overwhelmed handling 300+ daily patient queries across messaging, website chat, and email, with average response times exceeding 6 hours.",
    solution: "Deployed an AI-powered omni-platform chatbot trained on their FAQ database and appointment system, integrated with their booking calendar.",
